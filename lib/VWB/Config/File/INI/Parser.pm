package VWB::Config::File::INI::Parser;
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new VWB::Config::File::INI::Parser(@_);
...
=head1 SYNOPSIS
 ...
 my $parser = VWB::Config::File::INI::Parser(masterConfigFile=>$file);
