...
=head1 NAME
 ...
 watcher.pl - Perl script for monitoring files on file system
...
=item B<--outdir>
  ...
  A default value is assigned /tmp/[username]/watcher.pl/[timestamp]/
...
=item B<--logfile>
  ...
  Default is set to [outdir]/watcher.pl.log
